  ...
  const featuredReviews: Review[] = [
    {
      ...
      comment:
        "I wore this to a charity gala and I've never received so many compliments in my life. The fit was absolute perfection, and the silk felt like a second skin. Truly a masterpiece of tailoring!",
      image:
    ...
    },
    {
      ...
      comment:
        "The attention to detail in the embroidery is stunning. It's light, breathable, and fits exactly as the measurements suggested. Shipping to Italy was faster than expected!",
      image:
    ...
    },
    {
      ...
      comment:
        "Customer service helped me choose the right size for my body type. The dress arrived in a beautiful box, smelling like lavender. It’s the little things that make DressShop the best.",
      image:
  ...
  const allReviews: Review[] = [
    {
      ...
      location: "Paris",
      rating: 5,
      dressName: "Lace Bridal",
      comment: "Breathtaking quality.",
      image: "",
      date: "2 days ago",
    },
    {
      ...
      rating: 4,
      dressName: "Boho Maxi",
      comment: "Slightly long, but beautiful fabric.",
      image: "",
      date: "1 week ago",
    },
    {
      ...
      location: "Lagos",
      rating: 3,
      dressName: "Cocktail Mini",
      comment: "The color is so vibrant!",
      image: "",
      date: "2 weeks ago",
    },
    {
      ...
      location: "LA",
      rating: 4,
      dressName: "Workwear Midi",
      comment: "Perfect for the office.",
      image: "",
      date: "1 month ago",
    },
  ];
      ...
      <section className="bg-slate-900 text-white py-24 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-7xl font-serif mb-6 italic">
              The DressShop <br />
              Experience
            </h1>
            <p className="text-slate-400 text-lg mb-8">
              Join over 10,000 women worldwide who found their perfect
              silhouette with us. Real stories, real confidence.
            </p>
            ...
            <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[500px] transition-all duration-500">
              ...
              <div className="md:w-1/2 p-12 md:p-16 flex flex-col justify-center">
                ...
                <h3 className="text-2xl font-bold mt-4 mb-2">
                  {featuredReviews[currentIndex].dressName}
                </h3>
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    {featuredReviews[currentIndex].location} •{" "}
                    {featuredReviews[currentIndex].date}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
          <div>
            ...
            <p className="text-slate-500">
              Read thoughts from our global community
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {allReviews.map((review) => (
            <div
              key={review.id}
              className="p-8 border border-slate-100 rounded-3xl bg-white hover:shadow-xl transition-shadow group"
            >
      ...
      <section className="px-6">
        <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
          ...
          <p className="text-slate-400 mb-10 max-w-lg mx-auto">
            Share your photos and story with us to get featured and receive 15%
            off your next order.
          </p>
